      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        <div className="flex justify-center">
          <Image
            width={450}
            height={450}
            src="/assets/about-us-hero-girl.png"
            alt=""
          />
        </div>
        ...
        <div className="order-2 lg:order-1">
          ...
          <p className="text-lg text-brown-b mb-8 leading-relaxed">
            At Billia, we&rsquo;re building more than just a payment app —
            we&rsquo;re creating a smarter, simpler way for everyday Nigerians
            to stay connected, pay their bills, and take control of their
            financial lives.
          </p>
        </div>
      </div>
