    ...
    <section className="relative overflow-hidden bg-hero pt-24 pb-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-12 items-center justify-center">
          ...
          <div className="relative z-10 transform rotate-0 hover:rotate-2 transition-transform duration-500 col-span-5">
            <Image width={400} height={400} src="/assets/phone.png" alt="phone" />
          </div>
        </div>
      </div>
    </section>
